...
function P(t2, i3) {
  if (!a2(t2) || !t2.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
  return s2 !== undefined ? s2.createHTML(i3) : i3;
}
function S2(t2, i3, s2 = t2, e3) {
  if (i3 === T)
    return i3;
  let h2 = e3 !== undefined ? s2._$Co?.[e3] : s2._$Cl;
  const o3 = c3(i3) ? undefined : i3._$litDirective$;
  return h2?.constructor !== o3 && (h2?._$AO?.(false), o3 === undefined ? h2 = undefined : (h2 = new o3(t2), h2._$AT(t2, s2, e3)), e3 !== undefined ? (s2._$Co ??= [])[e3] = h2 : s2._$Cl = h2), h2 !== undefined && (i3 = S2(t2, h2._$AS(t2, i3.values), h2, e3)), i3;
}
var t2 = globalThis;
...
// packages/auro-button/src/AuroButton.ts
class AuroButton extends r4 {
  static styles = i`
    button {
...
AuroButton = __legacyDecorateClassTS([
  t3("auro-button")
], AuroButton);
